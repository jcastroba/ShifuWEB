...
function ShiftDetailModal({ shift, onClose }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 font-roboto", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface dark:bg-secondary-dark rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-fade-in transition-colors duration-300", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "border-t border-border-color pt-4", children: [
        ...
        !shift.breaks || shift.breaks.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-text-muted italic", children: "No se registraron breaks en este turno." }) : /* @__PURE__ */ jsx("div", { className: "space-y-3", children: shift.breaks.map((b, index) => {
          ...
          return /* @__PURE__ */ jsxs("div", { className: "bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-3", children: [
            ...
            b.reason && /* @__PURE__ */ jsxs("div", { className: "text-sm text-text-main bg-surface dark:bg-gray-800 p-2 rounded border border-yellow-100 dark:border-yellow-800", children: [
